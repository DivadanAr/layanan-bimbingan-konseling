            ...
            <x-dropdown align="right" width="48">
                <x-slot name="trigger">
                    ...
                    <button
                        ...
                        <img class="h-8 w-8 rounded-full object-cover" src=" {{ asset('storage/profile-photos') }}/{{ Auth::user()->profile_photo_path }}"
                            alt="{{ Auth::user()->name }}" />
                    </button>
                    @else
                    <span class="inline-flex rounded-md">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="flex items-center px-4">
                ...
                <div class="shrink-0 mr-3">
                    <img class="h-10 w-10 rounded-full object-cover" src=" {{ asset('storage/profile-photos') }}/{{ Auth::user()->profile_photo_path }}"
                        alt="{{ Auth::user()->name }}" />
                </div>
                @endif
                        ...
                        <li>
                            <a class="dropdown-item" href="#">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-shrink-0 me-3">
                                        <div class="avatar">
                                            <img src=" {{ asset('storage/profile-photos') }}/{{ Auth::user()->profile_photo_path }}" alt
                                            class="w-px-40 h-auto rounded-circle" />
                                        </div>
                                    </div>
                                    @endif
