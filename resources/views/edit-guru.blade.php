                                ...
                                <form action="{{ route('guru.update',$guru->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="form">
                                            ...
                                            <div class="input-group">
                                                <input type="number" value="{{ $guru->nipd }}" name="nipd" class="form-control" placeholder="nisn"
                                    ...
                                    <div class="row">
                                        <div class="form">
                                            ...
                                            <div class="input-group">
                                                <input type="date" value="{{ $guru->tanggal_lahir }}" name="tanggal_lahir" class="form-control" placeholder="Tanggal Lahir"
                                    ...
                                    <div class="form">
                                        ...
                                        <select class="form-select placement-dropdown" name="kelamin"
                                            id="selectKelamin">
                                            <option  value="{{ $guru->kelamin }}" hidden>{{ $guru->kelamin }}</option>
                                    ...
                                    <div class="form">
                                        ...
                                        <select class="form-select placement-dropdown" value="{{ $guru->kelas }}" name="kelas_id" id="selectKelas">
                                            <option value="{{ $guru->kelas->id }}" selected>{{ $guru->kelas->nama }}</option>
                                    ...
                                    <div class="row">
                                        <div class="form">
                                            ...
                                            <div class="input-group">
                                                <input type="number" value="{{ $guru->telepon }}" name="telepon" class="form-control"
                                    ...
                                    <div class="form">
                                        ...
                                        <div class="input-group">
                                            <input type="text" value="{{ $guru->user->email }}" name="email" class="form-control" placeholder="Email"
