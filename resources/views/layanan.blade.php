                                    ...
                                    <div class="table-responsive text-nowrap">
                                        <table class="table table-striped">
                                            ...
                                            <tbody class="table-border-bottom-0">
                                                ...
                                                <tr>
                                                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i><strong>{{ $item->topik }}</strong></td>
                                                    <td>{{ $item->tempat }}</td>
                                                    <td>{{ $item->tanggal }}</td>
                                                        ...
                                                        <div class="modal fade" id="basicModal{{ $item->id }}" tabindex="-1"
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <form
                                                                        action="{{route('pribadi-reschedule',$item->id)}}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('PUT')
                                                        ...
                                                        <div class="dropdown">
                                                            <div class="dropdown-" style="display: flex">
                                                                ...
                                                                <button type="button" class="btn btn-warning"
                                                                    data-bs-toggle="modal" data-bs-target="#basicModal{{ $item->id }}"
                                                                    style="height: 33px; margin-right:2px">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="modal fade" id="basicModal{{$item->id}}" tabindex="-1"
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <form action="{{route('pribadi-done',$item->id)}}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('PUT')
                                                                        <div class="modal-header">
                                                                            ...
                                                                            <div class="row">
                                                                                <div>
                                                                                    <label for="hasil_kesimpulan"
                                                                                        class="form-label">hasi kesimpulan</label>
                                            ...
                                            <tbody class="table-border-bottom-0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $item->tanggal }}</td>
                                                    <td><span
                                                            class="badge bg-label-primary me-1">{{ $item->status }}</span>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-primary"
                                                            data-bs-toggle="modal" data-bs-target="#basicModal{{$konseling->id}}"
                                                            style="height: 33px; margin-right:2px; padding-top:4px">
                                                            <svg style="font-size: 15px;"
                                                                xmlns="http://www.w3.org/2000/svg" width="18"
                                                                height="18" viewBox="0 0 24 24">
                                                        ...
                                                        <div class="modal fade" id="basicModal{{$konseling->id}}" tabindex="-1"
                                                            aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <form action="{{route('pribadi-done',$konseling->id)}}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('PUT')
                                                                        <div class="modal-header">
